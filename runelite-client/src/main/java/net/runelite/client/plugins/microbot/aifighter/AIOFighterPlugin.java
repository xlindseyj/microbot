package net.runelite.client.plugins.microbot.aifighter;
...
import net.runelite.client.plugins.microbot.aifighter.bank.BankerScript;
import net.runelite.client.plugins.microbot.aifighter.cannon.CannonScript;
import net.runelite.client.plugins.microbot.aifighter.combat.*;
import net.runelite.client.plugins.microbot.aifighter.enums.PrayerStyle;
import net.runelite.client.plugins.microbot.aifighter.enums.State;
import net.runelite.client.plugins.microbot.aifighter.loot.LootScript;
import net.runelite.client.plugins.microbot.aifighter.safety.SafetyScript;
import net.runelite.client.plugins.microbot.aifighter.shop.ShopScript;
import net.runelite.client.plugins.microbot.aifighter.skill.AttackStyleScript;
import net.runelite.client.plugins.microbot.aifighter.combat.AttackNpcScript;
