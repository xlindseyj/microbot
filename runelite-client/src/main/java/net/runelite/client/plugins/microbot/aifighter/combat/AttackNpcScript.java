...
import net.runelite.client.plugins.microbot.aifighter.enums.AttackStyle;
import net.runelite.client.plugins.microbot.aifighter.enums.AttackStyleMapper;
                            ...
                            if (attackStyle != null) {
                                switch (attackStyle) {
                                    ...
                                    case RANGED:
                                        ...
                                        break;
                                    case MIXED:
                                        // For mixed attacks, could enable multiple protections or use default logic
                                        break;
                                }
                            }
                        } else {
