...
public class DefaultScript extends Script {
    ...
    private TileObject findAltarInHouse() {
        ...
        int[] altarIds = {
                ...
                ObjectID.ALTAR_13193,
                ObjectID.ALTAR_13194,
                ObjectID.ALTAR_13195,
                ObjectID.ALTAR_13196,
                ObjectID.ALTAR_13197,
                ObjectID.ALTAR_13198,
                ObjectID.ALTAR_13199,
                ObjectID.ALTAR_40872,
                ObjectID.ALTAR_40873,
                ObjectID.ALTAR_40874,
                ObjectID.ALTAR_40875,
                ObjectID.ALTAR_40876,
                ObjectID.ALTAR_40877,
                ObjectID.ALTAR_40878
        };
